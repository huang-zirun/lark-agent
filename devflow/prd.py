...
def render_prd_markdown(artifact: dict[str, Any], *, run_id: str | None = None) -> str:
    ...
    _append_list_section(lines, "待澄清问题", _list(artifact.get("open_questions")), empty="暂无待澄清问题。")
...
def build_prd_preview_card(
    ...
    *,
    ...
    questions = _preview_list("待澄清问题", _list(artifact.get("open_questions")), empty="暂无")
